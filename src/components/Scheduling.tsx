  ...
  return (
    <section id="galeria" className="bg-background_light flex items-center flex-col justify-center py-10">
      <div className="max-w-[1440px]">
        ...
        <div className="w-72 h-96 md:w-[34rem] md:h-[39rem] bg-white border border-[9B9EA3] rounded-md mt-10 relative">
          ...
          <form action="" className="mx-14 h-full my-11 font-barlow-semi-condensed flex flex-col items-center gap-6">
            <div className="w-full space-y-2">
              <label htmlFor="name" className="text-[5F6368] font-bold">Nome</label>
              <input className="border border-A19D9D bg-[#F9F9F9] w-full p-4 rounded-md" type="text" name="name" id="name" placeholder="Digite o seu Nome" />
            </div>
            ...
            <div className="flex justify-center flex-1 items-center">
              <button className="max-h-14 rounded-md font-roboto-slab bg-gold text-[#373535] font-bold p-4 text-sm flex items-center gap-2 md:text-base hover:bg-[#F9B256] transition-all ease-in-out duration-300">SOLICITAR AGENDAMENTO <FaWhatsapp className="mb-1" size={20} /></button>
            </div>
          </form>
        </div>
      </div>

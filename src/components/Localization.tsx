  ...
  return (
    <section id="localizacao" className="bg-background_black flex items-center flex-col justify-center py-10">
      <div className="max-w-[1440px] md:w-full md:mx-52 md:px-20">
        ...
        <div className="flex flex-col items-center md:items-start justify-center md:flex-row mt-10 md:gap-24">
          ...
          <div className="flex flex-col items-center justify-center md:items-start md:justify-between md:h-[450px]" >

export function Gallery() {
  return (
    <section id="galeria" className="bg-background_light flex items-center flex-col justify-center mt-10 pb-10">
      ...
      <div className="mt-4 md:mt-20 grid gap-2 md:gap-8 grid-cols-[64px_64px_64px] grid-rows-[64px_64px] md:grid-cols-[264px_264px_264px] md:grid-rows-[264px_264px] auto-cols-[64px] md:auto-cols-[264px] auto-rows-[64px] md:auto-rows-[264px] text-gray-700">
